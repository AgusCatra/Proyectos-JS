...
function renderShoppingCart(){
    const html = shoppingCart.items.map(item => {
        ...
        <div class="item">
            ...
            <div class="price">${numberToCurrency(dbItem.price)}  
            </div>
            <div class="qty">${item.qty} units</div>
            <div class="subtotal">
            ...
            <div class="actions">
                <button class="addOne" data-id="${item.id}">+
                </button>
                <button class="removeOne" data-id="${item.id}">-
                </button>
    ...
    `
        ...
        const totalContainer =`
            <div class="total">Total: ${numberToCurrency(total)}
